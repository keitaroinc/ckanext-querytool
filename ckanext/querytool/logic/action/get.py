...
def querytool_get_geojson_map_data(context, data_dict):
    geojson_url = data_dict.get('geojson_url')
    map_title_field = data_dict.get('map_title_field')
    map_key_field = data_dict.get('map_key_field', None)

    return h.get_geojson_map_data(geojson_url, map_title_field, map_key_field)
